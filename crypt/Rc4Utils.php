...
class Rc4Utils
{
    ...
    /**
     * @brief 用rc4算法生成加密串，除非提供密钥无法破解
     * @param string $string 加解密的明文或密文
     * @param string $operation 操作(ENCODE | DECODE), 加密或解密, 默认为 DECODE
     * @param string $key 密钥
     ...
     */
    public static function rc4($string, $operation = 'ENCODE', $key = '', $expiry = 0)
    {
        // 随机密钥长度 取值 0-32;
